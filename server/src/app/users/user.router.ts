...
export const createUserRouter = (): Router => {
  ...
  userRouter.get(
    ...
    tryCatch(instanceUserController.getAllUsers)
  );
  userRouter.get(
    "/roles",
    [checkRole(Roles.Admin)],
    tryCatch(instanceUserController.getAllRoles)
  );
  userRouter.patch(
    "/roles/:id",
    [checkRole(Roles.Admin)],
  ...
  userRouter.patch("/:id", tryCatch(instanceUserController.updateUserInfo));
  userRouter.delete(
    "/:id",
    [checkRole(Roles.Admin)],
    tryCatch(instanceUserController.removeUser)
  );
