...
import styles from "components/product-detail/product-detail-info/product-info.module.scss";
...
import ProductPrice from "components/product-detail/product-detail-info/components/product-price";
import ProductShotCharacteristics from "components/product-detail/product-detail-info/components/product-shot-characteristics";
import ProductDetailTitle from "components/product-detail/product-detail-info/components/product-title";
