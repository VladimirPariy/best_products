...
import AllCommentsWrapper from "components/product-detail/product-detail-tabs/components/comments-tab/components/all-comments-wrapper";
import CommentsList from "components/product-detail/product-detail-tabs/components/comments-tab/components/comments-list";
import SortButton from "components/product-detail/product-detail-tabs/components/comments-tab/components/sort-button";
...
const CommentsTab: FC<Props> = ({ product_id }) => {
  ...
  return (
    <AllCommentsWrapper>
      ...
      <Button submitHandler={addComment}>Write a Review</Button>
    </AllCommentsWrapper>
  );
};
