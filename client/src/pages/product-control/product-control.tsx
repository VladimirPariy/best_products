...
import {productsListTrigger, removeProductTrigger} from "lib/store/products/products-actions";
      ...
      </ContentContainer>
      {
        productsList.map(product => (
          <div key={product.product_id}
            ...
            <img src={product.product_images[0] ? ApiUrls.BASE_Image_URL + product.product_images[0].image_title : defaultImageForProduct}
                 alt=""
            ...
            <div className={styles.btnWrapper}>
              ...
              <button className={styles.deleteBtn} onClick={() => removeProduct(product.product_id)}>Delete</button>
            </div>
          </div>
        ))
      }
